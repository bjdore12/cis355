...
// 3/27/2020
//
// Code from George Corser's course lookup form...
...
function printCourses($prefix, $courseNumber, $instructor) {
    ...
    if (!empty($_GET['day'])) {
        $userSelectedDay = $_GET['day'];
        $term = "19/FA";
        $string = "https://api.svsu.edu/courses?prefix=$prefix&courseNumber=$courseNumber&term=$term&instructor=$instructor";
        echo "<h2>2019 - Fall</h2>";

        if ($userSelectedDay == "Monday") {
            echo "<h3> Monday </h3>";
            printListing($string, "M");
        } elseif ($userSelectedDay == "Tuesday") {
            echo "<h3> Tuesday </h3>";
            printListing($string, "T");
        } elseif ($userSelectedDay == "Wednesday") {
            echo "<h3> Wednesday </h3>";
            printListing($string, "W");
        } elseif ($userSelectedDay == "Thursday") {
            echo "<h3> Thursday </h3>";
            printListing($string, "R");
        } elseif ($userSelectedDay == "Friday") {
            echo "<h3> Friday </h3>";
            printListing($string, "F");
        } elseif ($userSelectedDay == "ONLINE") {
            echo "<h3> Online </h3>";
