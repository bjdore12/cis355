<?php
    ...
    echo "<a href=As03/customers.php>Assignment 3 Customers Database</a> - More practice with CRUD based web applications <-- customers<br>";
    echo "<a href=As03/events.php>Assignment 3 Events Database</a> - More practice with CRUD based web applications <-- events<br><br>";
