    ...
    <div class="container">
        <div>
            ...
            if($_SESSION["employee_title"] == "Administrator")
                echo "<a href=\"r_create.php\" class=\"btn btn-primary\">Create Room</a>";
            ?>
    ...
    <div class="container">
        ...
        <table class="table table-striped table-bordered">
            ...
            foreach ($pdo->query($sql) as $row) {
                ...
                echo '<a class="btn btn-outline-secondary btn-sm" href="r_read.php?id='.$row['id'].'">View</a>';
                echo ' ';
                if ($_SESSION['employee_title']=="Administrator")
                    echo '<a class="btn btn-success btn-sm" href="r_update.php?id='.$row['id'].'">Update</a>';
                echo ' ';
                if ($_SESSION['employee_title']=="Administrator") {
                    echo '<a class="btn btn-danger btn-sm" href="r_delete.php?id=' . $row['id'] . '">Delete</a>';
                }
                echo '</td>';
                echo '</tr>';
            }
