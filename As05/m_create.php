...
if ( !empty($_POST)) {
    ...
    if ($valid) {
        ...
        $sql = "INSERT INTO meetings (host_id, attendee_id, room_id, meeting_date, meeting_time) values(?, ?, ?, ?, ?)";
        $q = $pdo->prepare($sql);
        $q->execute(array($host, $attendee, $room, $date, $time));
        Database::disconnect();
...
<div class="container">
    ...
    <div class="span10 offset1">
        ...
        <form class="form-horizontal" action="m_create.php" method="post">
